...
public class MyGame {
    ...
    public void start() {
        ...
        for (int i = 1; i <= 5; i++) {
            ...
            if (answer.equals(question.getCorrectOption())) {
                ...
                System.out.println("错误。正确答案是 " + question.getCorrectOption().toUpperCase() + ".");
            }
        }
    ...
    private MathQuestion generateQuestion() {
        ...
        // 随机决定选项位置
        if (Math.random() < 0.5) {
            return new MathQuestion(question, String.valueOf(correctAnswer), String.valueOf(wrongAnswer), "a");
        } else {
            return new MathQuestion(question, String.valueOf(wrongAnswer), String.valueOf(correctAnswer), "b");
        }
    }
    ...
    private class MathQuestion {
        ...
        public MathQuestion(String question, String optionA, String optionB, String correctOption) {
