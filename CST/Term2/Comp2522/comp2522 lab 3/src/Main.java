/**
 * The main class for testing the functionality of all iDevice classes. This class creates
 * instances of each iDevice subclass and tests their equality methods.
 *
 * <p>
 * The main method verifies the functionality of the IPod, IPad, IPhone, and IPhone16
 * classes by checking the equality and toString() methods.
 * </p>
 *
 * @author BCIT
 */
public class Main {
    public static void main(final String[] args)
    {
        ...
        iphone16_1 = new IPhone16(100.0, "Verizon", true,
                512); // 100 minutes, high-res camera, 512 GB
        iphone16_2 = new IPhone16(100.0, "Verizon", true,
                256); // 100 minutes, high-res camera, 256 GB
        iphone16_3 = new IPhone16(100.0, "Verizon", false,
